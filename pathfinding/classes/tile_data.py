...
class TileData:
    ...
    def __init__(self, **kwargs):
        ...
        self._attributes = np.array([self._attributes])
    ...
    def set_attribute(self, attribute: TileAttribute) -> None:
        ...
        self._attributes[0] += 1<<attribute
